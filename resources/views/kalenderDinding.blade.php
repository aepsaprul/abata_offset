                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control form-control-sm" id="jml_cetak" name="jml_cetak" autofocus required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-select form-select-sm" id="jenis_finishing" name="jenis_finishing" required>
                                            ...
                                            <option value="mata">Mata Ayam</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control form-control-sm" id="biaya_potong" name="biaya_potong" autofocus required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control form-control-sm" id="biaya_design" name="biaya_design" autofocus required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="number" class="form-control form-control-sm" id="biaya_akomodasi" name="biaya_akomodasi" autofocus required>
                                    </div>
                                </div>
                            </div>
                        </div>
