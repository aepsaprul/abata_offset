...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h5 class="text-center text-uppercase font-weight-bold"><span style="border-bottom: 1px solid #000; padding: 5px;">Data Jenis Kertas</span></h5>
        </div>
    </div>
    <div class="row mt-3">
        @if(session('status'))
    ...
    <div class="row mt-3">
        <div class="col-md-4">
            <a href="{{ route('jenis_kertas.create') }}" class="btn btn-info text-white" title="Tambah"><i class="fas fa-plus"></i></a>
        </div>
    </div>
    <div class="row mt-4">
        <table id="example" class="table table-bordered" style="width:100%">
            ...
            <tbody>
                @foreach ($jenis_kertas as $key => $jenis_kertas)
                <tr>
