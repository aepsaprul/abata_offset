        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" class="mt-3" action="{{ route('finishing.update', [$finishing->id]) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input
                                        ...
                                        value="{{ $finishing->nama_finishing }}">
                                </div>
